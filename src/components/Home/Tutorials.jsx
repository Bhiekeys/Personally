...
const Tutorials = () => {
  ...
  return (
    <div className="grid justify-center items-center bg-[#F2F4F7] pb-20 pt-20">
      <div className="flex justify-between">
        <h2 className="font-bold text-xl text-[#1D2939]">Tutorials</h2>
